  ...
  >
    ...
    >
      ...
      <p className="text-center text-[#1e293b] dark:text-[#f3f4f6] px-4 mb-6">
        Únete al Colegio de Ingenieros y forma parte de una comunidad
      ...
      <div className="mt-8 text-center">
        <h3 className="text-lg font-semibold mb-3 text-[#1e40af] dark:text-[#60a5fa]">
          Proceso de Afiliación
        </h3>
        <p className="text-[#1e293b] dark:text-[#f3f4f6] text-sm mb-4">
          Para iniciar tu proceso de afiliación, contacta con nuestra oficina o
          descarga el formulario de afiliación desde nuestra página web.
        </p>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {[
          ...
          >
            ...
            />
            <div className="p-4">
              <h4 className="font-semibold text-[#1e293b] dark:text-[#f3f4f6] mb-2">
                {item.titulo}
              </h4>
              <p className="text-sm text-[#1e293b] dark:text-[#f3f4f6]">
                {item.desc}
              </p>
            </div>
          </motion.div>
