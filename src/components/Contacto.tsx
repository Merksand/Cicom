...
const Contacto: React.FC = () => (
  <section
    id="contacto"
    className="py-12 bg-white dark:bg-[#1e293b] flex flex-col items-center"
  >
    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#1e40af] dark:text-[#60a5fa]">
      Contacto
    </h2>
    <div className="flex flex-col md:flex-row gap-8 max-w-4xl w-full px-4">
      <form
        className="flex-1 bg-[#f3f4f6] dark:bg-[#1e293b] rounded-xl shadow-xl p-8 flex flex-col gap-6 border border-[#e5e7eb] dark:border-[#334155]"
      ...
      <div className="flex-1 flex flex-col gap-4">
        <div className="bg-[#f3f4f6] dark:bg-[#1e293b] rounded-lg p-4 shadow">
          <h3 className="text-lg font-semibold mb-2 text-[#1e40af] dark:text-[#60a5fa]">
            Datos de contacto
          </h3>
          ...
          <p className="text-[#1e293b] dark:text-[#f3f4f6]">
            Facebook:{" "}
            <a
              href="https://www.facebook.com/SCZCICOM"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#1e40af] dark:text-[#60a5fa] hover:underline"
            >
              SCZCICOM
            </a>
          </p>
        ...
        <div className="h-56 w-full rounded-lg overflow-hidden shadow">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4056.069645748033!2d-63.19924949999999!3d-17.7984883!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x93f1e81f6f5fb405%3A0xf637740c9aa553bb!2sSociedad%20de%20Ingenieros%20de%20Bolivia%20Departamental%20Santa%20Cruz!5e1!3m2!1ses-419!2sbo!4v1757435337556!5m2!1ses-419!2sbo"
            width="100%"
            height="100%"
            style={{ border: 0 }}
